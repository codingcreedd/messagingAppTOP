export default function Loader({ description }) {
  return (
    <div className="z-10 fixed bottom-4 right-4 flex items-center space-x-3 bg-gradient-to-r from-[#1a2a3a] to-[#0f1923] p-3 max-md:p-1 rounded-full shadow-lg">
      <div className="relative w-6 h-6 max-md:w-3 max-md:h-3">
